...
void lua_create_and_run(const char* path)
	...
	int PrintX(lua_State* L)
	{
		...
		for (int i = 0; i < len; i++)
		{
			...
			if (lua_type(L, -1) == LUA_TNUMBER)
			{
				int n = LuaCore::Memory::LuaCheckIntegerU(L, -1);
				lua_pop(L, 1);
				lua_getglobal(L, "string");
...
#undef A
	...
	const luaL_Reg d2dFuncs[] = {
		{"fill_rectangle", LuaCore::D2D::LuaD2DFillRectangle},
		{"draw_rectangle", LuaCore::D2D::LuaD2DDrawRectangle},
		{"fill_ellipse", LuaCore::D2D::LuaD2DFillEllipse},
		{"draw_ellipse", LuaCore::D2D::LuaD2DDrawEllipse},
		{"draw_line", LuaCore::D2D::LuaD2DDrawLine},
		{"draw_text", LuaCore::D2D::LuaD2DDrawText},
		{"get_text_size", LuaCore::D2D::LuaD2DGetTextSize},
		{"push_clip", LuaCore::D2D::LuaD2DPushClip},
		{"pop_clip", LuaCore::D2D::LuaD2DPopClip},
		{"fill_rounded_rectangle", LuaCore::D2D::LuaD2DFillRoundedRectangle},
		{"draw_rounded_rectangle", LuaCore::D2D::LuaD2DDrawRoundedRectangle},
		{"load_image", LuaCore::D2D::LuaD2DLoadImage},
		{"free_image", LuaCore::D2D::LuaD2DFreeImage},
		{"draw_image", LuaCore::D2D::LuaD2DDrawImage},
		{"get_image_info", LuaCore::D2D::LuaD2DGetImageInfo},
		{"set_text_antialias_mode", LuaCore::D2D::LuaD2DSetTextAntialiasMode},
		{"set_antialias_mode", LuaCore::D2D::LuaD2DSetAntialiasMode},
		{"create_render_target", LuaCore::D2D::LuaD2DCreateRenderTarget},
		{"destroy_render_target", LuaCore::D2D::LuaD2DDestroyRenderTarget},
		{"begin_render_target", LuaCore::D2D::LuaD2DBeginRenderTarget},
		{"end_render_target", LuaCore::D2D::LuaD2DEndRenderTarget},
		{NULL, NULL}
	};
